...
求解相机外参 $T$，则是整个 vslam 的关键，将在后续学习。
...
[^3]: 见 [wikipedia-distortion][brown_conrady]. 原始论文，一个是1966年，一个是1919年，有点难以置信。下下来看了下，没找到书上一样的公式。
  书上的公式，大概都是后人不断改进的结果吧。 Wikipedia还提到一个简单改进的 division model 比 Brown-Corrady model 更好，
  看起来它少了 $p_1$, $p_2$ 项。去畸变是一个大的研究Topic，这些公式应该是最基础的吧。
